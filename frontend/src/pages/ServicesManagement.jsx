      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            Configure os valores de mão de obra e custos de insumos
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-gray-50 border-b">
            <tr>
              <th className="p-4 text-gray-400 uppercase text-[10px] font-black tracking-widest">
                Serviço / Descrição
              </th>
              <th className="p-4 text-gray-400 uppercase text-[10px] font-black tracking-widest text-center">
                Custo Est.
              </th>
              <th className="p-4 text-gray-400 uppercase text-[10px] font-black tracking-widest text-center">
                Preço Venda
              ...
              <th className="p-4 text-center text-gray-400 uppercase text-[10px] font-black tracking-widest">
                Ações
              </th>
            </tr>
          </thead>
