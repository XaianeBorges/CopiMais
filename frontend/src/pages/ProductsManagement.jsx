...
export function ProductsManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (erroData && typeof erroData === "object") {
        alert(erroData.message || "Erro inesperado no servidor.");
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Cadastre e gerencie o estoque da sua copiadora
          </p>
        </div>
        <button
          onClick={() => {
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="bg-gray-50 border-b">
              <tr>
                <th className="p-4 font-bold text-gray-400 text-xs uppercase tracking-widest">
                  Nome
                </th>
                <th className="p-4 font-bold text-gray-400 text-xs uppercase tracking-widest">
                  Descrição
                ...
                <th className="p-4 font-bold text-gray-400 text-xs uppercase tracking-widest text-center">
                  Ações
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-black uppercase ${product.quantidadeEstoque < 10 ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}
                    >
