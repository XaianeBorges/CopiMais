      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border border-white/20">
        ...
        <div className="p-8 pb-4 text-center space-y-4">
          <div className="flex flex-col items-center justify-center gap-4 mb-2">
            {/* Nome centralizado sem o bloco azul lateral */}
            <h1 className="text-5xl font-black text-[#000000] tracking-tighter">Copimais</h1>
            
            {/* Listras em coluna (uma embaixo da outra) */}
          ...
          <p className="text-gray-500 font-medium text-sm">Faça login para gerenciar sua copiadora</p>
        </div>
        ...
        <div className="p-8 pt-2">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-black text-gray-400 uppercase ml-1 tracking-[0.2em]">Usuário</label>
              <input
                type="text"
                placeholder="Nome"
                value={username}
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-black text-gray-400 uppercase ml-1 tracking-[0.2em]">Senha</label>
              <input
                type="password"
                placeholder="••••••••"
                value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#FF8C00] hover:bg-[#e67e00] text-white font-black py-4 rounded-2xl shadow-xl shadow-orange-100 transition-all active:scale-[0.98] flex items-center justify-center gap-2 text-lg mt-2"
            >
              {loading ? (
        ...
        <div className="bg-gray-50 p-6 text-center">
          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.3em]">
            CopiMais v1.0 • Gerenciamento Offline
          </p>
        </div>
      </div>
    </div>
